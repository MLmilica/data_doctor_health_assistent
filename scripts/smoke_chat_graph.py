"""Smoke test runner for the LangGraph chat flow with real LLM calls."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run a smoke test for the LangGraph chat flow.")
    parser.add_argument(
        "--message",
        type=str,
        default=_default_message(),
        help="User message for the graph.",
    )
    parser.add_argument(
        "--session-id",
        type=str,
